...
`keskos-creator-meta` pulls in the creator/media applications recommended by KeskOS.
...
- Current hard dependencies: `audacity`, `gimp`, `kdenlive`, `krita`, `obs-studio`, and `vlc`.
